...
export function MenuCard({ name, description, price, imageUrl, imageHint, customisable }: MenuCardProps) {
        ...
        <div className="absolute inset-x-0 bottom-0 flex flex-col items-center justify-end pb-3 bg-gradient-to-t from-black/60 to-transparent pt-12">
          {quantity > 0 ? (
            ...
            <div className="flex flex-col items-center gap-1 w-[85%]">
              <Button 
                className="w-full h-8 rounded-full bg-[#12B4A3] hover:bg-[#109e8f] text-white font-bold text-sm shadow-lg transition-transform active:scale-95"
