          ...
          <div className="p-5 pb-40 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0 py-0.5">
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <button 
                          onClick={() => onEdit(item)}
                          className="p-1 rounded-full bg-slate-50 hover:bg-slate-100 transition-colors shrink-0"
                        >
                    ...
                    <div className="flex items-center gap-2.5 bg-[#F8F9FA] px-1.5 py-1 rounded-full border border-slate-100 shrink-0">
                      <button 
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <h3 className="text-base font-bold text-[#1E2B4D]">You might also like</h3>
                ...
                {recommendations.map((rec) => (
                  <div key={rec.id} className="min-w-[140px] bg-white rounded-2xl shadow-sm border border-slate-50 overflow-hidden flex flex-col">
                    ...
                    <div className="p-3 space-y-2 flex-1 flex flex-col justify-between">
                      <p className="text-[11px] font-bold text-[#1E2B4D] leading-tight line-clamp-2">{rec.name}</p>
            ...
            <div className="bg-white p-5 rounded-[2rem] shadow-sm border border-slate-50 space-y-3">
