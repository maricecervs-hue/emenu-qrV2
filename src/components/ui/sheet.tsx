...
>(({ side = "right", className, children, ...props }, ref) => {
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full bg-white shadow-lg h-9 w-9 flex items-center justify-center transition-all hover:scale-110 active:scale-95 z-50 focus:outline-none focus:ring-2 focus:ring-[#12B4A3] focus:ring-offset-2">
